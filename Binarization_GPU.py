    ...
    program = compileProgram(
        ...
        compileShader('''
            ...
            void main() {
                ...
                L = 0.299 * texture2D(s_texture,vec2(tx,ty)).r + 0.587 * texture2D(s_texture,vec2(tx,ty)).g + 0.114 * texture2D(s_texture,vec2(tx,ty)).b;
                if(L >= 0.4) {
                    L = 1.0;
                }
                else {
...
window = glutCreateWindow("Binarization_GPU")
